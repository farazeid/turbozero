...
# This script runs a short training session to verify STRICT Behaviour Shapley.
# It uses Go 9x9, a small batch size, and a small buffer to avoid OOM.

echo "Starting short validation run (SEPARATE NETWORKS) with Go 9x9..."
